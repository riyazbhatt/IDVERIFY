...
<body class="bg-gray-100 min-h-screen p-6">
    <div class="max-w-7xl mx-auto bg-white rounded-lg shadow p-6">
        ...
        <nav class="mb-6">
            <a href="<?php echo e(route('department_head.appointments')); ?>" class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">View Appointments</a>
        </nav>
        <section>
...
<?php /**PATH /project/sandbox/user-workspace/id-verification-system/resources/views/department_head/dashboard.blade.php ENDPATH**/ ?>